-- ============================================================
--  LaptopRent (LapTopia) — Database Schema FINAL
--  MySQL 8.0+ / MariaDB 10.6+
--  CHANGELOG:
--    [FIX] Seed password sekarang bcrypt-hashed (bukan plaintext)
--    [FIX] Tambah tabel otp_ktp yang hilang
--    [FIX] jaminan_file_path diubah ke nullable
--    [FIX] Semua tabel pakai CREATE IF NOT EXISTS
--    [FIX] INSERT pakai IGNORE agar aman di-run ulang
-- ============================================================

CREATE DATABASE IF NOT EXISTS laptoprent
...
-- ─────────────────────────────────────────
-- 3. TRANSAKSI
-- BUG FIX: jaminan_file_path → NULL-able
-- ─────────────────────────────────────────
...
-- 4. KONTRAK DIGITAL
-- ─────────────────────────────────────────
CREATE TABLE IF NOT EXISTS kontrak_digital (
...
-- ─────────────────────────────────────────
-- 5. OTP KTP
-- BUG FIX: Tabel ini HILANG dari versi asli!
--   Dibutuhkan oleh /api/otp/* — tanpa ini server crash.
-- ─────────────────────────────────────────
...
--  SEED DATA
-- ============================================================
-- BUG FIX: Password HARUS di-hash bcrypt sebelum INSERT.
--   Versi asli menyimpan plaintext → login SELALU GAGAL karena
--   bcrypt.compare('Admin@1234', 'Admin@1234') = FALSE.
--
--   Hash di bawah = bcrypt(cost=12) dari password asli:
--     Admin@1234  →  $2a$12$wPdONp3...
--     Kasir@1234  →  $2a$12$irG85Yw...

INSERT IGNORE INTO users (username, email, password, role, nama_lengkap, no_hp) VALUES
(
  'admin',
  'admin@laptoprent.com',
  '$2a$12$wPdONp3.6S1WDOQrktp/V.kPlNIF4NVA3y.T/DRLeUjvyUxbwQtce',
  'admin',
  'Administrator',
  '08000000000'
),
(
  'kasir1',
  'kasir@laptoprent.com',
  '$2a$12$irG85YwtyaGXCGDEe8CV5ePr04TVXjUK/YKKh3HLq5uUkQGL06.6.',
  'kasir',
  'Kasir Satu',
  '08111111111'
);

INSERT IGNORE INTO laptops (nomor_seri, merk_tipe, spesifikasi, harga_sewa_per_hari, status) VALUES
...
('LNV-Y9-001',  'Lenovo IdeaPad Gaming 3', 'AMD Ryzen 5 6600H, 8GB RAM, 512GB SSD, RTX 3050, Win11',       70000, 'Maintenance');
